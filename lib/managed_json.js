  ...
  return {
    ...
    _isReachable() {
      const reachRec = (o, p, i) => {
        ...
        return reachRec(o[p[i]], p, i + 1);
      };

      return reachRec(this.rootObject_, this.path_, 0);
    },
    ...
    set(target, property, value, receiver) {
      if (ManagedJson.isManaged(value)) {
        throw new TypeError('A managed object cannot be assigned to another managed object.');
      }
      if (this.readOnly_) {
      ...
      if (!this._isReachable()) {
        throw new Error('Attempt to modify an orphaned object.');
      }
